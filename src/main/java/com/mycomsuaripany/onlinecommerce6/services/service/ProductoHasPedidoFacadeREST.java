 ...
 */
@Stateless
@Path("com.mycomsuaripany.onlinecommerce6.entities.productohaspedido")
public class ProductoHasPedidoFacadeREST extends AbstractFacade<ProductoHasPedido> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, ProductoHasPedido entity) {
        super.edit(entity);
    }
    ...
    public ProductoHasPedido find(@PathParam("id") Integer id) {
